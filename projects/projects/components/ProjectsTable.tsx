...
const projects: Project[] = [
  ...
  { id: 'proj-004', name: 'Bergstrom E-commerce', client: 'ORD-2026-0802', type: 'web', status: 'draft', model: 'llama3.2', step: 'Brief', stepNum: 1, fileSize: '�', lastModified: '3 days ago', created: '28 Aug 2026' },
